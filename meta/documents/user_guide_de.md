...
4. Wählen Sie einen oder mehrere Container, in denen die PayPal PLUS Wall genutzt werden soll. Beachten Sie dazu die Erläuterungen in Tabelle 4.
...
<caption>Tab. 4: Container verknüpfen</caption>
	...
	<tbody>
		...
		<tr>
        	...
        	<td>Der Container <strong>Script loader: After scripts loaded</strong> muss verknüpft sein, um Scripts zu aktivieren.</td>
        		</tr>
		<tr>
			<td>
		...
		<tr>
        	...
        	<td>Mit <strong>My account: Additional payment information</strong> verknüpfen, um dem Kunden im Mein-Konto-Bereich die Möglichkeit zu geben, nach nicht erfolgreicher Zahlung eine erneute Zahlung durchzuführen. Für PayPal wird die Schaltfläche "Jetzt zahlen" angezeigt, für PayPal PLUS wird die Wall angezeigt.<br />Mit <strong>Order confirmation: Additional payment information</strong> verknüpfen, um dem Kunden in der Bestellbestätigung die Möglichkeit zu geben, nach nicht erfolgreicher Zahlung eine erneute Zahlung durchzuführen. Für PayPal wird die Schaltfläche "Jetzt zahlen" angezeigt, für PayPal PLUS wird die Wall angezeigt.</td>
        </tr>	
		<tr>
        	<td>
...
3. Wählen Sie den Bereich **PayPal icon**.
...
<td>&nbsp;</td>
	...
	<caption>
		Tab. 5: Ereignisaktion zur automatischen Rückzahlung der PayPal-Zahlung
	</caption>
</table>
