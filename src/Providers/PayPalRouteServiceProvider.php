...
class PayPalRouteServiceProvider extends RouteServiceProvider
{
    ...
    public function map(Router $router, ApiRouter $apiRouter)
    {
        ...
        $router->get('payment/payPal/expressCheckoutReview' , 'PayPal\Controllers\PaymentController@expressCheckoutReview');
        ...
        // Get the PayPal order checkout
        $router->get('payment/payPal/payOrderNow/{orderId}', 'PayPal\Controllers\PaymentController@orderCheckout');

        // Get the PayPal PLUS order checkout
        $router->get('payment/payPalPlus/paymentOrderWall/{orderId}', 'PayPal\Controllers\PaymentController@orderPaymentWall');

        // Get the PayPal PLUS wall
        $router->get('payment/payPalPlusWall/refresh', 'PayPal\Controllers\PaymentController@refreshPayPalPlusWall');

        // Get the PayPal (PLUS) order success and cancellation URLs
        $router->get('payment/payPal/payOrderSuccess/{orderId}', 'PayPal\Controllers\PaymentController@payOrderSuccess');
        $router->get('payment/payPal/payOrderCancel/{orderId}' , 'PayPal\Controllers\PaymentController@payOrderCancel');
